  ...
  return (
    ...
    >
      <Handle
        ...
        className="!bg-purple-400 !border-purple-700 !w-3 !h-3"
      />
      {/* Header */}
      ...
      <div className="px-3 py-2 space-y-0.5">
        ...
        {data?.actionLabel && (
          <p className="text-xs text-purple-300/70 truncate">⚡ {data.actionLabel}</p>
        )}
        {!data?.actionId && (
          <p className="text-xs text-red-400/70">No action selected</p>
        )}
      </div>
      <Handle
        type="source"
