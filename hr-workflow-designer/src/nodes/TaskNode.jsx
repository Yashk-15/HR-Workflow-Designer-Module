  ...
  return (
    ...
    >
      <Handle
        ...
        className="!bg-blue-400 !border-blue-700 !w-3 !h-3"
      />
      {/* Header */}
      ...
      <div className="px-3 py-2 space-y-0.5">
        ...
        {data?.assignee && (
          <p className="text-xs text-blue-300/70 truncate">👤 {data.assignee}</p>
        )}
        {data?.dueDate && (
          <p className="text-xs text-blue-300/50 truncate">📅 {data.dueDate}</p>
        )}
      </div>
      <Handle
        type="source"
