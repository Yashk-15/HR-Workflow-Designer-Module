  ...
  return (
    ...
    >
      <Handle
        ...
        className="!bg-rose-400 !border-rose-700 !w-3 !h-3"
      />
      {/* Header */}
      ...
      <div className="px-3 py-2 space-y-0.5">
        ...
        {data?.endMessage && (
          <p className="text-xs text-rose-300/60 truncate italic">"{data.endMessage}"</p>
        )}
        {data?.summaryFlag && (
          <span className="inline-block text-xs bg-rose-500/20 text-rose-300 px-1.5 py-0.5 rounded-full">
            Summary On
          </span>
        )}
      </div>
